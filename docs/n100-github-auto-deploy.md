...
5. Compose 설정을 검증한 뒤 `docker compose -f docker-compose.yml -f docker-compose.n100.yml up -d --build`를 실행합니다.
...
docker compose -f docker-compose.yml -f docker-compose.n100.yml logs --tail=100
```
