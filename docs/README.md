...
| 문서 | 확인 내용 |
|---|---|
| [Book·Portal K3s 배포 결과](reviews/20260921_K3s앱배포_검증결과.md) | 실제 이미지 적용·데이터 보존·외부 health와 뉴스 보류 상태 |
| [차량 배포 결과](reviews/20260921_차량배포_검증결과.md) | health 설정·멱등성 변경의 실제 운영 적용 |
| [뉴스 복구 호환 검토안](reviews/20260921_뉴스복구호환_적용검토안.md) | 준비 완료·운영 미적용 범위 |
| [SLO 증적 실패 원인](reviews/20260921_SLO증적실패_원인분석.md) | 다중 시계열 원인·검증된 수정안·운영 미적용 |
