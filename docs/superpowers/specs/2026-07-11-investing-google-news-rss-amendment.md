...
Google News RSS의 `site:kr.investing.com/news`와 `site:kr.investing.com` 검색 결과를 수집하고, RSS의 출처가 정확히 `Investing.com 한국어`인 항목만 남긴다. 제목 끝의 `- Investing.com 한국어`와 `By Investing.com` 표시는 제거하고, `By Investing.com`만 있는 비정상 항목은 버린다.
