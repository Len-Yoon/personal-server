...
- [`README.md`](/Users/len/PycharmProjects/personal-server/README.md): 프로젝트 개요, 실행 방법, 운영 기준
- [`.env.example`](/Users/len/PycharmProjects/personal-server/.env.example): 환경 변수 예시
- [`docs/caddy-cloudflare.md`](/Users/len/PycharmProjects/personal-server/docs/caddy-cloudflare.md): Caddy + Cloudflare 공개 HTTPS 운영
- [`docs/cloudflare-tunnel.md`](/Users/len/PycharmProjects/personal-server/docs/cloudflare-tunnel.md): Cloudflare Tunnel 운영
- [`docs/n100-mt4-setup.md`](/Users/len/PycharmProjects/personal-server/docs/n100-mt4-setup.md): Windows N100 + MT4 + WSL2 운영
- [`docs/20260702_운영보안QA_점검보고서.md`](/Users/len/PycharmProjects/personal-server/docs/20260702_운영보안QA_점검보고서.md): 운영보안 QA 점검 보고서

## 3. 핵심 코드 위치

- [`portal-web/app/services/security.py`](/Users/len/PycharmProjects/personal-server/portal-web/app/services/security.py): 보안 헤더, 인증 실패 기록, 보안 상태
- [`portal-web/app/services/file_store.py`](/Users/len/PycharmProjects/personal-server/portal-web/app/services/file_store.py): 파일 저장, 업로드 제한, 경로 안전 처리
- [`portal-web/app/routers/dashboard.py`](/Users/len/PycharmProjects/personal-server/portal-web/app/routers/dashboard.py): 포털 메인, `/admin/status`
- [`portal-web/app/routers/files.py`](/Users/len/PycharmProjects/personal-server/portal-web/app/routers/files.py): 파일함 라우트와 다운로드/삭제 보호
