    ...
    services = [
        {
            ...
            "url": os.getenv("NEWS_SERVICE_URL", "https://news.lenserver.com"),
            "status": "운영중",
        ...
        },
        {
            ...
            "url": os.getenv("YOUTUBE_MEMO_URL", "https://memo.lenserver.com"),
            "status": "운영중",
        ...
        },
        {
            ...
            "url": os.getenv("BOOK_MEMO_URL", "https://book.lenserver.com"),
            "status": "운영중",
