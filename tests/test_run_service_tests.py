...
EXPECTED_GROUPS = {
    ...
    "crawler-worker": ("3.11", "crawler-worker/requirements.txt", [], "crawler-worker", "python3 -m unittest tests.crawler_worker.test_datetime_format tests.crawler_worker.test_investing_news_rss tests.crawler_worker.test_news_service tests.crawler_worker.test_news_routes tests.crawler_worker.test_rss_news"),
