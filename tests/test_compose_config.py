...
class ComposeConfigTests(unittest.TestCase):
    ...
    def test_ci_collects_and_enforces_agent_loop_evidence(self):
        ...
        expected_matrix_entries = {
            ...
            "maintenance": "python3 -m unittest tests.test_compose_config tests.test_maintenance tests.test_windows_bootstrap tests.test_deploy_n100 tests.test_verify_change_scope tests.test_change_harness tests.test_change_harness_evals",
        }
